...
typedef enum {
    ...
    SDL_APP_WILLENTERBACKGROUND, /**< The application is about to enter the
                                    ...
                                    Android in onPause()
                                */
    SDL_APP_DIDENTERBACKGROUND,  /**< The application did enter the background
                                    and may not get CPU for some time  Called on
                                    iOS in applicationDidEnterBackground()  Called
    ...
    SDL_RENDER_TARGETS_RESET = 0x2000, /**< The render targets have been reset
                                        ...
                                        */
    SDL_RENDER_DEVICE_RESET, /**< The device has been reset and all textures
...
typedef struct SDL_ControllerDeviceEvent {
    ...
    Uint32 timestamp; /**< In milliseconds, populated using SDL_GetTicks() */
    Sint32 which; /**< The joystick device index for the ADDED event, instance
                     id for the REMOVED or REMAPPED event */
...
typedef struct SDL_AudioDeviceEvent {
    ...
    Uint32 which; /**< The audio device index for the ADDED event (valid until
                     ...
                     the REMOVED event */
    Uint8 iscapture; /**< zero if an output device, non-zero if a capture
                        device. */
    Uint8 padding1;
    Uint8 padding2;
    Uint8 padding3;
...
typedef struct SDL_TouchFingerEvent {
    Uint32
        type; /**< ::SDL_FINGERMOTION or ::SDL_FINGERDOWN or ::SDL_FINGERUP */
    Uint32 timestamp;    /**< In milliseconds, populated using SDL_GetTicks() */
...
typedef struct SDL_DropEvent {
    Uint32 type; /**< ::SDL_DROPBEGIN or ::SDL_DROPFILE or ::SDL_DROPTEXT or
                    ::SDL_DROPCOMPLETE */
    Uint32 timestamp; /**< In milliseconds, populated using SDL_GetTicks() */
    char* file; /**< The file name, which should be freed with SDL_free(), is
                   NULL on begin/complete */
