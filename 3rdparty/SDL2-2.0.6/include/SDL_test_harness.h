 ...
 * one. \param userExecKey Custom execution key provided by user, or 0 to
 * autogenerate one. \param filter Filter specification. NULL disables. Case
 * sensitive. \param testIterations Number of iterations to run each test case.
 *
