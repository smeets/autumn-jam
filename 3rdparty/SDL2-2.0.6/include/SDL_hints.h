 ...
 * can turn it off to avoid the window manager thinking the app is hung. The hint is checked in CreateWindow.
 */
 ...
 * 8.1, and RT, Microsoft mandates that this policy be available via the Windows
...
* raise fake mouse events. This is the behaviour of SDL <= 2.0.3. (default) "1"       - Mouse events will be handled separately from pure
* touch events.
*
