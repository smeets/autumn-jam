 ...
 * etc. \param buttonid The pointer to which user id of hit button should be
 * copied.
 *
 ...
 * will block execution of that thread until the user clicks a button or closes the messagebox.
 */
